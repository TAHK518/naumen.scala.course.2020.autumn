object Exercises {
    ...
    def sumByFunc(leftVec0: Vector2D, leftVec1: Vector2D, targetFunc: (Vector2D, Vector2D) => Double, rightVec0: Vector2D, rightVec1: Vector2D): Double = {
        targetFunc(leftVec0, leftVec1) + targetFunc(rightVec0, rightVec1)
    }
    ...
    */
    ...
    def weightBall(ball: (Int, Double)): Double = {
        (4.0/3.0) * java.lang.Math.PI * Math.pow(ball._1, 3) * ball._2
    }
